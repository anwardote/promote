            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        ...
                        {!! Form::model($data, [ 'url' => [URL::route('category.edit'), $data->id], 'method' => 'post'] ) !!}
                        ...
                        <?php
                        $cms_category_values=array_prepend($cms_category_values, '-','NA');
                            ?>
                        <div class="form-group">
                            {!! Form::label('parent_id','Select parent (If necessary): ') !!}
                            {!! Form::select('parent_id', $cms_category_values, $data->parent_id, ["class"=>"form-control "]) !!}
