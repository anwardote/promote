    ...
    <div class="col-md-12" id="tutorialForm">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title bariol-bold"><i class="fa fa-users"></i> Add New CMS Category</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('name', null, [ 'class' => 'form-control', 'placeholder' => 'CMS Category here.']) !!}
                        ...
                        ?>
                        <div class="form-group">
                            {!! Form::label('parent_id','Select parent (If necessary): ') !!}
                            {!! Form::select('parent_id', $cms_category_values, '', ["class"=>"form-control "]) !!}
