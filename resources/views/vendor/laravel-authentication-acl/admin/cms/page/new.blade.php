        ...
        <div class="col-md-12" id="tutorialForm">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-bold"><i class="fa fa-users"></i> Add New CMS Page</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('template', $template, $select_page, ["class"=>"form-control "]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <select name="banner_type" class="form-control" id="banner_type" label="Banner Type"
                                        type="banner_type">
