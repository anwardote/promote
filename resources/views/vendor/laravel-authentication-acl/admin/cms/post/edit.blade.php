                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8 col-xs-12">
                            ...
                            {!! Form::model($data, [ 'url' => [URL::route('post.edit'), $data->id], 'method' => 'post', 'files' => true] ) !!}

                            <div class="form-group">
                                {!! Form::label('cms_category_id','Select Category: *') !!}
                                {!! Form::select('cms_category_id', array_map('ucwords', $cms_category_values), $data->cms_category_id, ["class"=>"form-control permission-select chosen-select"]) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::date('date', $data->date, [ 'class' => 'form-control', 'placeholder' => '']) !!}
