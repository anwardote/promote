    ...
    <div class="col-md-12" id="tutorialForm">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title bariol-bold"><i class="fa fa-users"></i> Add New Driver Name</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('introductions', null, [ 'class' => 'form-control', 'placeholder' => 'Driver Introductions here.']) !!}
                            <span class="text-danger">{!! $errors->first('introductions') !!}</span>
                        </div>

                        <div class="form-group">
                            <div class="form-group">
                                {!! Form::label('image','Driver Thumbnail: ') !!}                                
