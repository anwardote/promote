            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        ...
                        {!! Form::model($data, [ 'url' => [URL::route('driver.edit'), $data->id], 'method' => 'post', 'files' => true] ) !!}

                        <div class="form-group">
                            {!! Form::label('driver_id','Select Driver: *') !!}
                            {!! Form::select('driver_id', $driverName_output_values, '', ["class"=>"form-control permission-select chosen-select"]) !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('driver_model','Driver Model:') !!}
                            {!! Form::text('driver_model', null, [ 'class' => 'form-control', 'placeholder' => 'Supported Driver Models here.']) !!}
                            <span class="text-danger">{!! $errors->first('driver_model') !!}</span>
                        </div>

                        <div class="form-group">
                            {!! Form::label('supports','Supports:') !!}
                            {!! Form::text('supports', null, [ 'class' => 'form-control', 'placeholder' => 'Supported Driver here.']) !!}
                        ...
                        <div class="form-group input_fields_wrap">
                            ...
                            <?php
                            $downloadArr = explode(',', $data->d_links);
                            $l = (count($downloadArr));
                            $i = 0;
                            ?>
                            @if($l > 1)
