                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('country[]', $country_output_values, explode(',',$data->country_id), ["class"=>"form-control permission-select chosen-select", "id"=>'country', 'multiple'=>'multiple']) !!}
                        ...
                        <div class="form-group input_fields_wrap">
                           ...
                           // dd($downloadArr);
                            ...
                            @endforeach
                            @else
                            {!! Form::text('download_link[]', $downloadArr[0], [ 'class' => 'form-control', 'placeholder' => 'Download links here.']) !!}
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('d_sizes', $data->d_sizes, [ 'class' => 'form-control', 'placeholder' => 'Download size here.']) !!}
