                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="form-group">
                                {!! Form::label('remark','Extra Information (if have) : ') !!}
                                {!! Form::textarea('remark', null, [ 'class' => 'form-control', 'placeholder' => 'Extra Information/message here.']) !!}
                                <span class="text-danger">{!! $errors->first('remark') !!}</span>
                            </div>

                            {!! Form::hidden('requested_for', $user_data->id) !!}
